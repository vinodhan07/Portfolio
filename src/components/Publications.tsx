                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
                  <div className="flex-1">
                    ...
                    <h3 className="text-2xl md:text-3xl font-black text-foreground mb-3 leading-tight group-hover:text-primary transition-colors">
                      <TextReveal splitBy="chars" variant="typing" delay={0.2}>
                        {pub.title}
                      </TextReveal>
                    </h3>
                    <p className="text-muted-foreground font-bold tracking-wide">
                      <TextReveal splitBy="chars" variant="typing" delay={1.5}>
                        {pub.journal}
                      </TextReveal>
                    </p>
                  </div>
                  ...
                  <Button
                    ...
                    className="bg-primary text-primary-foreground hover:bg-primary/90 h-14 px-8 rounded-xl text-sm font-black uppercase tracking-widest flex items-center gap-3 transition-all shadow-[0_10px_30px_-10px_rgba(var(--primary-rgb),0.5)] cursor-pointer"
                  >
                    View Publication
